...
-- ----------------------------
-- Table structure for tb_customer_im_chat
-- ----------------------------
DROP TABLE IF EXISTS `tb_customer_im_chat`;
CREATE TABLE `tb_customer_im_chat` (
...
CREATE TABLE `tb_customer_chat` (
  ...
  `active_scene` varchar(24) DEFAULT NULL COMMENT '最近成功完成回复的一级场景',
  `active_master` varchar(32) DEFAULT NULL COMMENT '最近成功完成回复的Master Agent',
...
-- ----------------------------
-- Table structure for tb_customer_chat_message
-- ----------------------------
DROP TABLE IF EXISTS `tb_customer_chat_message`;
CREATE TABLE `tb_customer_chat_message` (
  `message_id` bigint(20) NOT NULL COMMENT '消息ID',
  `im_chat_id` bigint(20) NOT NULL COMMENT '长会话ID',
  `chat_id` bigint(20) NOT NULL COMMENT '短会话ID',
  `user_id` bigint(20) UNSIGNED NOT NULL COMMENT '所属用户ID',
  `sender_type` varchar(16) NOT NULL COMMENT '发送方',
...
-- ----------------------------
-- Table structure for tb_customer_chat_biz_ref
-- ----------------------------
DROP TABLE IF EXISTS `tb_customer_chat_biz_ref`;
CREATE TABLE `tb_customer_chat_biz_ref` (
...
-- ----------------------------
-- Table structure for tb_customer_handoff
-- ----------------------------
DROP TABLE IF EXISTS `tb_customer_handoff`;
CREATE TABLE `tb_customer_handoff` (
...
-- ----------------------------
-- Table structure for tb_customer_agent_run
-- ----------------------------
DROP TABLE IF EXISTS `tb_customer_agent_run`;
CREATE TABLE `tb_customer_agent_run` (
  ...
  `graph_version` varchar(16) NOT NULL DEFAULT 'v5' COMMENT 'LangGraph版本',
  ...
  `route_source` varchar(16) DEFAULT NULL COMMENT 'RULE或LLM',
  `router_rule_version` varchar(32) DEFAULT NULL COMMENT '关键词规则版本',
  `route_confidence` decimal(5,4) DEFAULT NULL COMMENT '最终场景路由置信度',
  `scene_scores` longtext COMMENT '关键词场景得分JSON',
  `matched_rule_ids` longtext COMMENT '命中的规则ID JSON',
  `primary_scene` varchar(24) DEFAULT NULL COMMENT '一级场景',
  `active_master` varchar(32) DEFAULT NULL COMMENT '最终场景Master',
  `scene_history` longtext COMMENT '场景执行历史JSON',
  `specialist_history` longtext COMMENT '专业Agent调用审计JSON',
  `specialist_call_count` int(11) NOT NULL DEFAULT 0 COMMENT '专业Agent调用次数',
